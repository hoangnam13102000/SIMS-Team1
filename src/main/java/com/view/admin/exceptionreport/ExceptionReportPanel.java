...
public class ExceptionReportPanel extends BaseCrudPanel<ExceptionReport> {
    ...
    public ExceptionReportPanel() {
        ...
        // STT | Nội dung | Người gửi | Ngày gửi | Người xử lý | Ngày xử lý | Trạng thái
        table.setColumnWidths(40, 320, 130, 110, 130, 110, 110);
        table.setColumnMinWidths(36, 200, 100, 95, 100, 95, 95);
