...
public class AdminMainFrame extends JFrame {
    ...
    private final java.util.function.Consumer<OrderStatusChangedEvent> orderStatusListener =
    ...
    private void buildContent() {
        ...
        JPanel dashboardPanel = isInventoryManager()
                ...
                : new DashboardPanel();
        layout.addPage("dashboard", Lang.get("sidebar.dashboard"), FontAwesomeSolid.TACHOMETER_ALT,
                dashboardPanel, AppPermission.DASHBOARD_VIEW);

        layout.addSection(Lang.get("sidebar.section.users"));
        layout.addPage("users", Lang.get("sidebar.users.short"), FontAwesomeSolid.USERS_COG,
                new UserAccountPanel(), AppPermission.USER_MANAGE);
        layout.addPage("employees", Lang.get("sidebar.employees.short"), FontAwesomeSolid.USER_TIE,
                new EmployeePanel(), AppPermission.USER_MANAGE);
        layout.addPage("customers", Lang.get("sidebar.customers.short"), FontAwesomeSolid.ID_CARD,
                new CustomerPanel(), AppPermission.CUSTOMER_MANAGE);

        layout.addSection(Lang.get("sidebar.section.catalog"));
        layout.addPage("categories", Lang.get("sidebar.categories.short"), FontAwesomeSolid.TAGS,
                new CategoryPanel(), AppPermission.CATEGORY_MANAGE);
        ...
        layout.addPage("suppliers", Lang.get("sidebar.suppliers.short"), FontAwesomeSolid.TRUCK,
                new SupplierPanel(), AppPermission.SUPPLIER_MANAGE);
        layout.addPage("exceptionReport", Lang.get("sidebar.exceptionReport"), FontAwesomeSolid.EXCLAMATION_TRIANGLE,
